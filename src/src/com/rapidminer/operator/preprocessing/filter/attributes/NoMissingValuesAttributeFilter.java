...
/**
 * This class implements a no missing value filter for attribtues. Attributes are filtered and hence be removed from 
 * exampleSet if there are missing values in one of the examples in this attribute.
 * 
 * @author Sebastian Land
 * @version $Id: NoMissingValuesAttributeFilter.java,v 1.3 2008/05/09 19:23:26 ingomierswa Exp $
 */
public class NoMissingValuesAttributeFilter implements AttributeFilterCondition {
	...
	public void check(Example example) {
		remove = remove || Double.isNaN(example.getValue(attribute));
	}
